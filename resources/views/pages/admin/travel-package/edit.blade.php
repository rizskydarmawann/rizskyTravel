            ...
            <div class="card-body">
                <form action="{{ route('travel-package.update', $item->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="numer" class="form-control" name="price" placeholder="Price" value="{{  $item->price }}">
                    </div>
...
@endsection
@push('addon-script')
<script src="{{ url('backend/js/tinymce.min.js') }}" referrerpolicy="origin"></script>
